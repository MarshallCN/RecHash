...
def _ark(actual, predicted, k=10, rank_weights=True):
    """
...
def mark(actual, predicted, k=10, rank_weights=True):
    """
    ...
    """
    return np.mean([_ark(a,p,k, rank_weights) for a,p in zip(actual, predicted)])

def _apk(actual, predicted, k=10, rank_weights=True):
    """
...
def mapk(actual, predicted, k=10, rank_weights=True):
    """
    ...
    """
    return np.mean([_apk(a,p,k,rank_weights) for a,p in zip(actual, predicted)])
